...
export default function NextButton() {
  ...
  return (
    <button
      className="hidden md:flex absolute h-[400px] top-0 right-0 z-40 items-center justify-center w-24 hover:bg-black hover:bg-opacity-50 transition-opacity group "
