  ...
  return (
    ...
    >
      <Image
        ...
        alt="teacher and student in class"
        width={604}
        height={505}
        draggable="false"
        loading="lazy"
      ...
      <article>
        ...
        <h2 className="font-poppins text-[26px] mb-5 font-extrabold text-left text-titleColor xl:text-[2.188rem]">
        ...
        <div className="flex flex-col gap-2 mt-6 leading-7 lg:gap-8 lg:mt-10">
          <p className="text-[1rem] font-normal text-textColor xl:text-[1.063rem]">
            ...
            <strong className="font-bold">
              {t("HomePage.About.description1span")}
            </strong>
          </p>
          <p className="text-[16px] font-normal text-textColor">
            {t("HomePage.About.description2")}{" "}
            <strong className="font-bold">
              {t("HomePage.About.description2span")}{" "}
            </strong>
            {t("HomePage.About.description2End")}
          </p>
        </div>
      </article>
    </section>
