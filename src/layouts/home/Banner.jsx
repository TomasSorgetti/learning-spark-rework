...
export default async function HomeBanner({ t }) {
  return (
    <section
      id="banner"
      className="mt-20 min-h-screen pt-6 pb-[300px] px-4 text-center bg-[url('/images/banner/bg_mobile.png')] bg-bottom bg-no-repeat md:mt-26 lg:mt-16 lg:px-8 lg:h-[560px] lg:min-h-[560px] lg:py-20 lg:text-left lg:bg-[url('/images/banner/bg_desktop.png')] lg:bg-center lg:bg-cover lg:flex lg:items-center w-full"
    >
